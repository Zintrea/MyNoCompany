...
config_research = {
    ...
    "temperature": 0.4,       # ความกาวต่ำติดดิน
    "top_p": 0.5,             # เลือกแต่คำที่ชัวร์ๆ
    "top_k": 20,              # ตัดคำแปลกๆ ทิ้งหมด
    "max_output_tokens": 2000, # ห้ามบ่นยาวเกิน 1000 คำ (ประหยัดโควตา)
}

# ⚖️ สายตรรกะ (Editor)
config_editor = {
    "config_list": fallback_config_list,
    "temperature": 0.4,       # ยืดหยุ่นได้บ้าง
...
config_writer = {
    "config_list": fallback_config_list,
    "temperature": 0.4,       # ปล่อยของเต็มที่
    "top_p": 1.0,             # เปิดรับทุกความเป็นไปได้ของภาษา
    "top_k": 60,              # ให้โอกาสคำแปลกๆ ได้เกิด
    "max_output_tokens": 2000, # เขียนนิยายได้ยาวสะใจ (สูงสุดของรุ่น Flash)
}
